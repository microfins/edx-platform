...
class CourseMetadataUtilsTestCase(TestCase):
    ...
    def test_course_metadata_utils(self):
        ...
        time_zone_normal_datetime = datetime(2016, 03, 27, 00, 59, 00, tzinfo=utc)
        time_zone_daylight_parsable = "2016-03-27 01:00:00"
        time_zone_daylight_datetime = datetime(2016, 03, 27, 01, 00, 00, tzinfo=utc)
            ...
            FunctionTest(course_start_datetime_text, [
                ...
                TestScenario(
                    (DEFAULT_START_DATE, advertised_start_parsable, 'DATE_TIME',
                     utc, nop_gettext, mock_strftime_localized),
                ...
                TestScenario(
                    (test_datetime, None, 'SHORT_DATE', utc, nop_gettext, mock_strftime_localized),
                ...
                TestScenario(
                    (DEFAULT_START_DATE, None, 'SHORT_DATE', utc, nop_gettext, mock_strftime_localized),
                    'TBD'
                ),
                ...
                TestScenario(
                    (DEFAULT_START_DATE, time_zone_normal_parsable, 'DATE_TIME',
                     timezone('Europe/Paris'), nop_gettext, mock_strftime_localized),
